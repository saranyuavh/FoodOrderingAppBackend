...
public class AddressControllerTest {
    ...
    public void shouldSaveAddress() throws Exception {
        when(mockCustomerService.getCustomerByAuthToken("database_accesstoken2")).thenReturn(new CustomerEntity());
    ...
    public void shouldNotSaveAddressWithNonExistingAccessToken() throws Exception {
        when(mockCustomerService.getCustomerByAuthToken("non_existing_access_token"))
        ...
        verify(mockCustomerService, times(1)).getCustomerByAuthToken("non_existing_access_token");
    ...
    public void shouldNotSaveAddressWithSignedOutUser() throws Exception {
        when(mockCustomerService.getCustomerByAuthToken("database_accesstoken"))
        ...
        verify(mockCustomerService, times(1)).getCustomerByAuthToken("database_accesstoken");
        verify(mockAddressService, times(0)).getStateByUUID(anyString());
        verify(mockAddressService, times(0)).saveAddress(any(), any());
    }
    ...
    public void shouldNotSaveAddressWithExpiredSessionUser() throws Exception {
        when(mockCustomerService.getCustomerByAuthToken("database_accesstoken1"))
        ...
        verify(mockCustomerService, times(1)).getCustomerByAuthToken("database_accesstoken1");
        verify(mockAddressService, times(0)).getStateByUUID(anyString());
        verify(mockAddressService, times(0)).saveAddress(any(), any());
    }
    ...
    public void shouldDeleteAddress() throws Exception {
        ...
        when(mockCustomerService.getCustomerByAuthToken("database_accesstoken2")).thenReturn(customerEntity);
